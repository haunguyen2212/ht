                ...
                {/* <li className="relative bg-white flex flex-col justify-between border rounded shadow-md hover:shadow-primary-400">
                    <a className="relative" href="/tool/writey-ai">
                        <div className="relative w-full aspect-video">
                            <Image width={100} height={100} className="rounded w-full h-full object-cover"
                                src="/featured1.jpg" alt="Writey A.I" loading="lazy"/>

                            <div
                                className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-b from-indigo-800 to-indigo-500 text-white">
