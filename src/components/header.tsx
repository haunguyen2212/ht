        ...
        <nav className="w-full fixed z-50 bg-white border-gray-200 dark:bg-gray-900">
            <div className="flex flex-wrap items-center justify-between mx-auto p-4 xl:py-6 xl:px-16">
                ...
                <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    <DarkModeButton />
                    <Link href={'/login'} className="py-3 px-5 rounded-xl flex items-center gap-2 text-base font-semibold text-indigo-700 shadow-sm shadow-transparent bg-indigo-100 transition-all duration-500 hover:bg-indigo-200 focus-within:outline-0 focus-within:bg-indigo-200 dark:text-white dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus-within:bg-indigo-700">
