...
const Post: React.FC< { params: { slug: string } }> = ({ params }) => {
    ...
    const getData = async () => {
        try{
            const res = await axios.get<IDetail<Post>>(`${API_URL}/post/${params.slug}`);  
            ...
            <div className="max-w-3xl mx-auto my-10 md:my-24">
                <div className="mt-3 bg-white rounded-b lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal dark:bg-gray-900">
                    <div className="mx-5 md:mx-0">
                        <h1 className="text-gray-900 font-bold text-4xl dark:text-white">{post?.title}</h1>
                        <div className="py-5 text-sm font-regular text-gray-900 flex">
                            <span className="mr-3 flex flex-row items-center">
                            <svg className="text-indigo-600" fill="currentColor" height="13px" width="13px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512">
                                <path d="M256,0C114.837,0,0,114.837,0,256s114.837,256,256,256s256-114.837,256-256S397.163,0,256,0z M277.333,256
                                    c0,11.797-9.536,21.333-21.333,21.333h-85.333c-11.797,0-21.333-9.536-21.333-21.333s9.536-21.333,21.333-21.333h64v-128
                                    c0-11.797,9.536-21.333,21.333-21.333s21.333,9.536,21.333,21.333V256z">
                                </path>
                            </svg>
                            <span className="ml-2 text-gray-900 dark:text-white">{params.slug}</span>
                            </span>
                            ...
                            <a href="#" className="flex flex-row items-center hover:text-indigo-600  mr-3">
                                ...
                                <span className="ml-2 text-gray-900 dark:text-white">AliSher Azimi</span></a>
                            ...
                            <a href="#" className="flex flex-row items-center hover:text-indigo-600">
                                ...
                                <span className="ml-2 text-gray-900 dark:text-white">activewear</span></a>
                        </div>
                        <hr/>
